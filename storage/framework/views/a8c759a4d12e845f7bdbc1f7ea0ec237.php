                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-start mb-4">
                            ...
                            <span class="fw-medium d-block mt-1 text-heading"><?php echo e(session('login_email')); ?></span>
                        </p>
                        ...
                        <form method="POST" action="<?php echo e(route('auth.verify-pin')); ?>" id="pinForm">
                            <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                    <div class="invalid-feedback d-block text-center mt-2"><?php echo e($message); ?></div>
                                <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <form id="resendForm" method="POST" action="<?php echo e(route('auth.resend-pin')); ?>" style="display: none;">
        <?php echo csrf_field(); ?>
    </form>
...
<?php /**PATH /Users/ajspryn/Project/finboard/resources/views/auth/verify-pin.blade.php ENDPATH**/ ?>