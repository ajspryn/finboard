...
unset($__errorArgs, $__bag); ?>"
                                       id="biaya" name="biaya" value="<?php echo e(old('biaya')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                       id="cash_ratio" name="cash_ratio" value="<?php echo e(old('cash_ratio')); ?>"
                                       placeholder="Contoh: 15.50">
                                <span class="input-group-text">%</span>
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" min="0" step="0.01"
                                       class="form-control <?php $__errorArgs = ['pendapatan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       id="pendapatan" name="pendapatan" value="<?php echo e(old('pendapatan')); ?>"
