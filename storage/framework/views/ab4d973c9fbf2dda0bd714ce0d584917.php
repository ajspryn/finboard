                ...
                function renderIndicatorCard(indicator, value, change) {
                    ...
                    return `
                        <div class="col-12 mb-3">
                            <div class="card financial-highlight-card h-100 w-100 border-${indicator.color} border-opacity-25 shadow-sm" style="min-height: 140px;">
                                <div class="card-body text-center p-3 d-flex flex-column justify-content-center">
                                    ...
                                    <div class="change-indicator mt-auto">
                                        ${changeHtml}
                                    </div>
                                </div>
                            </div>
