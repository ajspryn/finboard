                ...
                <div class="card-header d-flex justify-content-between align-items-center bg-label-primary">
                    <div class="card-title mb-0">
                        ...
                        <small class="text-muted d-block">
                            ...
                            Data per <?php echo e(formatPeriod($startDay ?? null, $endDay ?? null, $filterMonth, $filterYear)); ?>

                        </small>
                        <small class="text-muted d-block">
                            <i class="ti ti-clock me-1"></i>
                            Data terupdate: <?php echo e(formatLastUpdated($lastUpdated['financial_highlight'] ?? null)); ?>
                    ...
                    <div class="d-flex gap-2 align-items-center">
                        ...
                        <!-- Export PDF Button -->
                        <a href="<?php echo e(route('export.dashboard', request()->query())); ?>" class="btn btn-success btn-sm" target="_blank">
            ...
            <div class="card h-100 border-info border-2">
                <div class="card-header d-flex justify-content-between bg-label-info">
                    <div class="card-title mb-0">
                        ...
                        <small class="text-muted d-block">
                            <i class="ti ti-clock me-1"></i>
                            Data terupdate: <?php echo e(formatLastUpdated($lastUpdated['tabungan'] ?? null)); ?>
            ...
            <div class="card h-100 border-success border-2">
                <div class="card-header d-flex justify-content-between bg-label-success">
                    <div class="card-title mb-0">
                        ...
                        <small class="text-muted d-block">
                            <i class="ti ti-clock me-1"></i>
                            Data terupdate: <?php echo e(formatLastUpdated($lastUpdated['pembiayaan'] ?? null)); ?>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <small class="text-muted d-block">
                            <i class="ti ti-clock me-1"></i>
                            Data terupdate: <?php echo e(formatLastUpdated($lastUpdated['deposito'] ?? null)); ?>
...
function formatNominal(amount) {
    ...
    if (npfDistributionEl) {
        ...
        const originalValues = <?php echo json_encode($npfDistribution['values'], 15, 512) ?>;
        const originalLabels = <?php echo json_encode($npfDistribution['labels'], 15, 512) ?>;
