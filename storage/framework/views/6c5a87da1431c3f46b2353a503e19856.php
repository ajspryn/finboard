        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <form id="clearForm" action="<?php echo e(route('funding.clear')); ?>" method="POST" style="display: inline;">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="month" name="month" required>
                                            ...
                                            <option value="01" <?php echo e(old('month') == '01' ? 'selected' : ''); ?>>Januari</option>
                                            <option value="02" <?php echo e(old('month') == '02' ? 'selected' : ''); ?>>Februari</option>
                                            <option value="03" <?php echo e(old('month') == '03' ? 'selected' : ''); ?>>Maret</option>
                                            <option value="04" <?php echo e(old('month') == '04' ? 'selected' : ''); ?>>April</option>
                                            <option value="05" <?php echo e(old('month') == '05' ? 'selected' : ''); ?>>Mei</option>
                                            <option value="06" <?php echo e(old('month') == '06' ? 'selected' : ''); ?>>Juni</option>
                                            <option value="07" <?php echo e(old('month') == '07' ? 'selected' : ''); ?>>Juli</option>
                                            <option value="08" <?php echo e(old('month') == '08' ? 'selected' : ''); ?>>Agustus</option>
                                            <option value="09" <?php echo e(old('month') == '09' ? 'selected' : ''); ?>>September</option>
                                            <option value="10" <?php echo e(old('month') == '10' ? 'selected' : ''); ?>>Oktober</option>
                                            <option value="11" <?php echo e(old('month') == '11' ? 'selected' : ''); ?>>November</option>
                                            <option value="12" <?php echo e(old('month') == '12' ? 'selected' : ''); ?>>Desember</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="year" name="year" required>
                                            ...
                                            <option value="<?php echo e($y); ?>" <?php echo e(old('year') == $y ? 'selected' : (date('Y') == $y ? 'selected' : '')); ?>><?php echo e($y); ?></option>
                                            <?php endfor; ?>
                                        </select>
                                    </div>
                                </div>
